...
const getProperties = () => [
  ...
  { id:5, title:"Road-Facing Open Plot",     location:"Kadthal, Maheshwaram",               area:"Various Sizes", type:"Open Plot",  tag:"Available", highlight:"Road Facing",       img:img7  },
  { id:6, title:"Layout Entry Plot",         location:"Rachloor, Ranga Reddy",              area:"Various Sizes", type:"Open Plot",  tag:"Hot",       highlight:"Near Entrance",     img:img1  },
];
...
/* ── MAIN COMPONENT ── */
export default function KarthikFortune() {
  const [dark,      setDark]      = useState(false);
  const [filter,    setFilter]    = useState("All");
  const [menuOpen,  setMenuOpen]  = useState(false);
  const [scrolled,  setScrolled]  = useState(false);
  const [lightbox,  setLightbox]  = useState(null);
  const [form,      setForm]      = useState({ name:"", phone:"", email:"", interest:"Buy Open Plot", message:"" });
      ...
      <header style={{
        ...
        <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 5%", height:66, display:"flex", alignItems:"center", justifyContent:"space-between", gap:12 }}>
          ...
          <a href="#" style={{ display:"flex", alignItems:"center", gap:10, flexShrink:0 }}>
            ...
            <div>
              <div style={{ fontFamily:"'DM Serif Display',serif", fontSize:16, color:T.text, lineHeight:1.15, whiteSpace:"nowrap", letterSpacing:-0.2 }}>Karthik Fortune City</div>
          ...
          <div className="hero-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:52, alignItems:"center" }}>
            ...
            <div>
              ...
              <p className="a3" style={{ color:T.sub, fontSize:16, lineHeight:1.8, marginBottom:12, maxWidth:480 }}>
                Welcome to <strong style={{ color:T.text }}>Karthik Fortune City</strong> — your trusted real estate partner in Rachloor, Maheshwaram, Kadthal, Amangal and Tukuguda.
              </p>
      ...
      <section id="gallery" style={{ background:T.surface, borderTop:`1px solid ${T.border}`, borderBottom:`1px solid ${T.border}`, padding:"80px 5%" }}>
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:44 }}>
            ...
            <p style={{ color:T.sub, fontSize:14, marginTop:10 }}>Real photos from Karthik Fortune City, Rachloor. Click any photo to enlarge.</p>
          </div>
          ...
          <div className="about-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:56, alignItems:"center" }}>
            ...
            <div>
              ...
              <p style={{ color:T.sub, fontSize:15, lineHeight:1.85, marginBottom:16 }}>
                Welcome to <strong style={{ color:T.text }}>Karthik Fortune City Rachloor</strong> — where you can buy and sell open plots, villa plots, and villas. Our team is committed to helping you find the right property for your needs and budget.
              </p>
      ...
      <section id="contact" className="sec" style={{ padding:"80px 5%" }}>
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:48 }}>
            ...
            <h2 style={{ fontFamily:"'DM Serif Display',serif", fontSize:"clamp(1.7rem,4vw,2.6rem)", letterSpacing:-0.4, color:T.text }}>Contact Karthik Fortune City</h2>
          </div>
          <div className="contact-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1.4fr", gap:28, alignItems:"start" }}>
            {/* Details */}
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              <div style={{ background:T.card, borderRadius:16, border:`1px solid ${T.border}`, padding:"24px 22px" }}>
                ...
                {[
                  ...
                  ["📧","Email",   "karthikfortunecity@gmail.com",       "mailto:karthikfortunecity@gmail.com"],
                  ["📍","Address", "1-210 Rachloor, Maheshwaram, Ranga Reddy, Telangana 501359","https://maps.google.com/?q=1-210+Rachloor+Maheshwaram"],
                  ["▶","YouTube", "youtube.com/@ArjunYadav55G",             "https://www.youtube.com/@ArjunYadav55G"],
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <input type="email" placeholder="Email Address (optional)" value={form.email} onChange={e=>setForm({...form,email:e.target.value})}
                    style={{ width:"100%", padding:"12px 13px", borderRadius:9, border:`1.5px solid ${T.border}`, background:T.raised, color:T.text, fontSize:14, marginBottom:12 }}/>
                  <select value={form.interest} onChange={e=>setForm({...form,interest:e.target.value})}
                    style={{ width:"100%", padding:"12px 13px", borderRadius:9, border:`1.5px solid ${T.border}`, background:T.raised, color:T.text, fontSize:14, marginBottom:12, cursor:"pointer" }}>
                    {["Buy Open Plot","Buy Villa Plot","Buy Villa","Sell Property","Free Site Visit","General Enquiry"].map(o => <option key={o}>{o}</option>)}
                  </select>
                  <textarea placeholder="Tell us your requirements — location, budget, size preference..." rows={4} value={form.message} onChange={e=>setForm({...form,message:e.target.value})}
                    style={{ width:"100%", padding:"12px 13px", borderRadius:9, border:`1.5px solid ${T.border}`, background:T.raised, color:T.text, fontSize:14, marginBottom:16, resize:"vertical" }}/>
      ...
      <footer style={{ background:dark?"#070e09":"#0e1a11", padding:"52px 5% 28px" }}>
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div className="footer-grid" style={{ display:"grid", gridTemplateColumns:"1.5fr 1fr 1fr 1fr", gap:36, marginBottom:44 }}>
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
                ...
                <div style={{ fontFamily:"'DM Serif Display',serif", fontSize:16, color:"#fff", lineHeight:1.2 }}>Karthik Fortune City</div>
              </div>
          ...
          <div className="footer-bottom" style={{ borderTop:"1px solid rgba(255,255,255,0.08)", paddingTop:22, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:10 }}>
            <p style={{ color:"rgba(255,255,255,0.28)", fontSize:12 }}>© 2026 Karthik Fortune City Rachloor. All rights reserved.</p>
