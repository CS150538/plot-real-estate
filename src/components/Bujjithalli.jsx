...
/* ── MAIN COMPONENT ── */
export default function Bujjithalli() {
  ...
  const onSubmit = async (event) => {
    ...
    if (data.success) {
      ...
      alert(`Thanks ${name}! We received your enquiry and will contact you shortly.`);
      event.target.reset();
      ...
      <header style={{
        ...
        <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 5%", height:66, display:"flex", alignItems:"center", justifyContent:"space-between", gap:12 }}>
          ...
          <nav className="desktop-nav" style={{ display:"flex", alignItems:"center", gap:2, flexShrink:0 }}>
            ...
            <a href="tel:+916145614544" style={{ marginLeft:8 }}>
              <button className="btn-g" style={{ padding:"8px 16px", borderRadius:8, fontSize:13, fontWeight:600, whiteSpace:"nowrap" }}>📞 61456-14544</button>
            </a>
          </nav>
        ...
        <div style={{ maxHeight:menuOpen?"520px":"0", overflow:"hidden", transition:"max-height 0.35s ease", background:T.surface, borderTop:menuOpen?`1px solid ${T.border}`:"none" }}>
          <div style={{ padding:"6px 5% 20px" }}>
            ...
            <a href="tel:+916145614544" onClick={closeMenu}>
              <button className="btn-g" style={{ marginTop:16, width:"100%", padding:"13px", borderRadius:9, fontSize:15, fontWeight:600 }}>📞 Call Now: 61456-14544</button>
            </a>
          </div>
        </div>
      </header>
        ...
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div className="about-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:56, alignItems:"center" }}>
            ...
            <div>
              ...
              <a href="tel:+916145614544">
                <button className="btn-g" style={{ padding:"12px 26px", borderRadius:9, fontSize:14, fontWeight:600 }}>📞 Call: 61456-14544</button>
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="contact-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:28, alignItems:"start" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              <div style={{ background:T.card, borderRadius:16, border:`1px solid ${T.border}`, padding:"24px 22px" }}>
                ...
                {[
                  ["📞","Phone",   "+91 61456-14544",                      "tel:+916145614544"],
              ...
              {submitted ? (
                <div style={{ textAlign:"center", padding:"48px 0" }}>
                  ...
                  <div style={{ color:T.sub, fontSize:14, lineHeight:1.8 }}>
                    ...
                    Or call: <a href="tel:+916145614544" style={{ color:G, fontWeight:600 }}>61456-14544</a>
                  </div>
                </div>
              ) : (
                <form onSubmit={onSubmit}>
                  ...
                  <textarea name="message" placeholder="Your Message *" rows={4} required
                    style={{ width:"100%", padding:"12px 13px", borderRadius:9, border:`1.5px solid ${T.border}`, background:T.raised, color:T.text, fontSize:14, marginBottom:20, resize:"vertical", fontFamily:"inherit" }}/>
        ...
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div className="footer-grid" style={{ display:"grid", gridTemplateColumns:"1.5fr 1fr 1fr 1fr", gap:36, marginBottom:44 }}>
            <div>
              ...
              <a href="tel:+916145614544" style={{ display:"inline-block", marginTop:14, color:"#4ade80", fontSize:14, fontWeight:600 }}>📞 61456-14544</a>
            </div>
            {[
